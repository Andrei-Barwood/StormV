...
cat > "src/microburst_detection/sensors/anemometer.py" << 'ANEM_EOF'
...
cat > "src/microburst_detection/fusion/kalman_filter.py" << 'KALMAN_EOF'
...
cat > "src/microburst_detection/utils/logger.py" << 'LOGGER_EOF'
...
cat > "src/microburst_detection/api/routes.py" << 'ROUTES_EOF'
